...
public interface CompiladorConstants {
  ...
  /** RegularExpression Id. */
  int TOKEN_OPEN_PARENTHESIS = 104;
  /** RegularExpression Id. */
  int TOKEN_CLOSE_PARENTHESIS = 105;
  /** RegularExpression Id. */
  int TOKEN_OPEN_BRACKET = 106;
  /** RegularExpression Id. */
  int TOKEN_CLOSE_BRACKET = 107;
  /** RegularExpression Id. */
  int TOKEN_OPEN_BRACE = 108;
  /** RegularExpression Id. */
  int TOKEN_CLOSE_BRACE = 109;
  /** RegularExpression Id. */
  ...
  int TOKEN_TILDE = 112;
  /** RegularExpression Id. */
  int TOKEN_DECIMAL_EXPONENT = 113;
  /** RegularExpression Id. */
  int TOKEN_DECIMAL_FLOAT_LITERAL = 114;
  /** RegularExpression Id. */
  int TOKEN_FLOAT_LITERAL = 115;
  /** RegularExpression Id. */
  int TOKEN_BINARY_LITERAL = 116;
  /** RegularExpression Id. */
  int TOKEN_OCTAL_LITERAL = 117;
  /** RegularExpression Id. */
  int TOKEN_DECIMAL_LITERAL = 118;
  /** RegularExpression Id. */
  int TOKEN_HEX_LITERAL = 119;
  /** RegularExpression Id. */
  int TOKEN_INT_LITERAL = 120;
  /** RegularExpression Id. */
