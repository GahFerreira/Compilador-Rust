...
public class Compilador implements CompiladorConstants {
  ...
  Token t;
    ...
    while (true) {
      ...
      case TOKEN_EQUAL:
      case TOKEN_ASSIGN:
      case TOKEN_PARENTHESIS_OP:
      case TOKEN_PARENTHESIS_CL:
      ...
      System.out.println("TOKEN_TILDE " + t.image);
        break;
      case TOKEN_FLOAT_LITERAL:
        t = jj_consume_token(TOKEN_FLOAT_LITERAL);
      System.out.println("TOKEN_FLOAT_LITERAL " + t.image);
        break;
      case TOKEN_INT_LITERAL:
        t = jj_consume_token(TOKEN_INT_LITERAL);
  ...
  static {
   ...
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x3813ffff,0x3813ffff,};
   }
