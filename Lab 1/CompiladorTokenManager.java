      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 57:
                  if ((0x3ff000000000000L & l) != 0L)
                     jjCheckNAddTwoStates(57, 36);
                  break;
               case 58:
                  if ((0x3ff000000000000L & l) != 0L)
                     jjCheckNAddTwoStates(58, 37);
                  break;
               case 59:
                  if ((0x3ff000000000000L & l) != 0L)
...
static final int[] jjnextStates = {
   57, 36, 58, 37, 59, 41, 43, 60, 36, 37, 41, 43, 50, 52, 53, 54, 
   15, 16, 17, 1, 3, 38, 39, 42, 48, 59, 41, 43, 4, 5, 6, 7, 
   8, 9, 10, 11, 18, 19, 20, 21, 22, 23, 24, 25, 44, 45, 46, 57, 
   36, 58, 37, 
};
...
static final long[] jjtoToken = {
   0x1fffffffffffff01L, 0x38f5fffffffffff8L, 
};
