...
int main(int argc, char * argv[]) {
    if (argc != 3 && argc != 1) {
		cout << "Parametros nomes dos arquivos: 1) csv com gramática e 2) csv com tabela LR1" << endl;
		return 1;
    }
    string nome_gramatica, nome_tab_lr1;
    if (argc == 1) {
		//cout << "Valores padrao utilizados: gramatica.conf e tabela_lr1.conf" << endl;
